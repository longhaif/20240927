...
export default function RootLayout({
  ...
  const [isRemoveTooltip, setIsRemoveTooltip] = useState(true)
  return (
    <html lang="en">
      <head>
        <meta charSet="utf-8" />
      ...
      <body>
        <GlobalContext.Provider
          value={{
            isPaused: isPaused,
            isRemoveTooltip: isRemoveTooltip,
            changePaused: (value: string) => {
              setIsPaused(value)
            },
            changeRemove: (value: boolean) => {
              setIsRemoveTooltip(value)
            },
          }}
        >
          <div id="__next">
            ...
            <main>
              <div className="sc-f7a1231a-0 AcwRI">
                <div className="sc-f7a1231a-1 gfcJIX">
                  <div className="sc-f7a1231a-2 jbudGT">
                    <a href="/" className="sc-f7a1231a-3 emSPmx">
                  ...
                  <div className="sc-f7a1231a-2 jbudGT hide-mobile">
                    <div className="sc-f7a1231a-4 jucUDh">
              ...
              <div className="selecto-selection rCS179bs95"></div>
              {children}
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="flex space-x-6">
                        <a href="https://www.tiktok.com/@pdfai" className="text-gray-400 hover:text-gray-500" target="_blank">
                          ...
                          <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2859 3333" fillRule="evenodd" clipRule="evenodd" className="h-6 w-6" aria-hidden="true" style={{ width: '20px' }}>
                    ...
                    <div className="mt-16 grid grid-cols-1 gap-8 xl:col-span-2 xl:mt-0">
                      <div className="md:grid md:grid-cols-3 md:gap-8">
                        ...
                        <div className="mt-10 md:mt-0">
                          ...
                          <ul role="list" className="mt-6 space-y-4 list-none p-0">
                            <li className="p-0 m-0">
                              <a href="https://pdf.ai/tools/resume-ai-scanner" className="text-sm leading-6 text-gray-600 hover:text-gray-900">
                                Resume AI Scanner
                              </a>
                            </li>
                            <li className="p-0 m-0">
                              <a href="https://pdf.ai/tools/invoice-ai-scanner" className="text-sm leading-6 text-gray-600 hover:text-gray-900">
                                Invoice AI Scanner
                              </a>
                            </li>
                            <li className="p-0 m-0">
                              <a href="https://pdf.ai/tools/quiz-ai-generator" className="text-sm leading-6 text-gray-600 hover:text-gray-900">
                                AI Quiz Generator
                              </a>
                            </li>
                            <li className="p-0 m-0">
                        ...
                        <div className="mt-10 md:mt-0">
                          ...
                          <ul role="list" className="mt-6 space-y-4 list-none p-0">
                            ...
                            <li className="p-0 m-0">
                              <a href="/compare/adobe-acrobat-reader-alternative" className="text-sm leading-6 text-gray-600 hover:text-gray-900">
